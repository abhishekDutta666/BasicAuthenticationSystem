...
public class UpdateName extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			...
			String new_pname=request.getParameter("username");
			...
			if(old_email!=null)
			{
				...
				String updating="update authinfo set pname=? where email=?";
				PreparedStatement updated=con.prepareStatement(updating);
				updated.setString(1, new_pname);
			...
			else
			{
				...
				String updating="update authinfo set pname=? where phno=?";
				PreparedStatement updated=con.prepareStatement(updating);
				updated.setString(1, new_pname);
			...
			response.getWriter().write("Name successfully changed");
			con.close();
